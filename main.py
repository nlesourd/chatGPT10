...
inverted_index = ppc.load_inverted_index(INVERTED_INDEX_PATH, COLLECTION_PATH)
...
eval.rank_queries(QUERIES_PATH, "data/results.txt", method=advanced_method, nb_lines=1000, kaggle=False)
